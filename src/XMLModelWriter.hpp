...
#ifndef __XMLModelWriter_hpp
#define __XMLModelWriter_hpp
...
public:
  XMLModelWriter(std::string filename);
  ~XMLModelWriter() {}
  void set_dimensions(const Vector<double>&);
